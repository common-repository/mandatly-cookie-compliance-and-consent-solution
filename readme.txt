...
4. Install the Mandatly Cookie Compliance and Consent solution plugin on your WordPress website. 
...
* Visit ‘Plugins’ then click on ‘Add New’
...
* Compatible with WordPress version 6.4.3 

**Version 1.2.2**

* Improved Message and UI

**Version 1.2.1**

* Introduced the demo banner
